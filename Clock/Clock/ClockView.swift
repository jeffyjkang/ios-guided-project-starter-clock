...
class ClockView: UIView {
    ...
    private var minutes = Hand(width: 3.0, length: 3.2, color: UIColor(named: "HandBackground")!, value: 0)
    private var hours = Hand(width: 4.0, length: 4.6, color: UIColor(named: "HandBackground")!, value: 0)
    ...
    private let clockBgColor = UIColor(named: "ClockBackground")!
    
    private let borderColor = UIColor(named: "HandBackground")!
    private let borderWidth: CGFloat = 2.0
    
    private let digitColor = UIColor(named: "HandBackground")!
